    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        ...
        <div class="text-center mb-5">
          <h2 class="display-5 fw-bold">Nous sommes à votre écoute</h2>
          <p class="lead">Que vous ayez une question, un besoin de devis ou simplement envie d'en savoir plus sur nos services, n'hésitez pas à nous contacter. Chez <strong>MHS COURTAGE</strong>, votre satisfaction est notre priorité.</p>
...
<!-- Lien vers Bootstrap JS (pour les composants interactifs) -->
